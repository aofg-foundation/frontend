<template lang="pug">
  div.b-text-field.b-builder__editor-field--text-field
    ...
    input.b-text-field-input.b-builder__editor-field-input.b-builder__editor-field-input--text-field.form-control(type='text' @keyup='change' v-model='currentValue')
</template>
